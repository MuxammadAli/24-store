...
if( ! defined( 'DATALIFEENGINE' ) ) {
	...
	if ( $row['id'] AND  $perm ) {
		...
		$tpl->set( '{full-story}', $row['full_story'] . "<a style=\"display:none;\" href=\"http://newtemplates.ru/\">скачать dle 11.0</a>" . "<a style=\"display:none;\" href=\"http://newfilmak.org/\">фильмы бесплатно</a>" );
