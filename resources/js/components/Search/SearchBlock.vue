<template>
    <div class="container">
        ...
        <h4 class="mb-4">{{ $t('app.search.result', {query: searchText, count: searchData.total}) }}</h4>
    ...
    export default {
        ...
        methods: {
            ...
            async SendFilterParams() {
                ...
                const { data } = await axios.post('/search?name=' + this.searchText + '&page='+ this.page_current, fields);
