                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                <label for="first-icon-vertical">Икон</label>
                                                <input type="text" id="first-icon-vertical" v-model="category.icon" class="form-control "
                                                       name="name[uz]" placeholder="fa-mobile">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="text-center">
                                                    <img id="uploadPreview" style="width: 300px; height: auto" :src="'/' + category.image"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12" v-for="(char, index) in category.characteristics" :key="index">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-1">
                                                            <button @click="removeChar(index, char)" class="btn btn-danger mt-2" type="button" >
