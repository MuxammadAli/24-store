                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item ">
                                <a href="{{ route('dashboard.units') }}">@lang('admin.units.title')</a>
                            </li>
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <form class="form form-vertical" action="{{ route('dashboard.units.edit', $unit->id) }}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="form-body">
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" required class="form-control @error('name.uz') is-invalid @enderror"
                                                           name="name[uz]" value="{{ old('name.uz', $unit->name['uz']) }}" placeholder="@lang('admin.branches.name') UZ">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nameru" required class="form-control @error('name.ru') is-invalid @enderror"
                                                           value="{{ old('name.ru', $unit->name['ru']) }}" name="name[ru]" placeholder="@lang('admin.branches.name') RU">
                                                    @error('name.ru')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="nameru">В корзину</label>
                                            <input type="number" min="0.5" step="0.5" id="count" required class="form-control @error('count') is-invalid @enderror"
                                                   value="{{ old('count', $unit->count) }}" name="count" >
